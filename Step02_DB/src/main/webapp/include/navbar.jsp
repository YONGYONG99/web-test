...
%>    
<!-- 
	navbar-expand-sm : width 576 px 이상에서 네비요소 펼치기
	navbar-expand-md : width 768 px 이상에서 네비요소 펼치기
	navbar-expand-lg : width 992 px 이상에서 네비요소 펼치기
 --> 
...
<nav class="navbar bg-light navbar-expand-sm">
  <div class="container">
    ...
    <!-- 
    	화면의 폭이 좁아 지면 나오는 버튼
    	#navabarNav 는 id 가 navbarNav 인 요소를 접었다 폈다 한다는 의미
     -->
